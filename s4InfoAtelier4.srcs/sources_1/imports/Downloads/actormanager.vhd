    ...
    if rising_edge(clk) then
      ...
      if (instruction_en = '1') then
            ...
            -- spawn sprite   0, 0
                ...
                if (instruction(19 downto 17) = "000") then
                    ...
                    actors(spriteIndex).tile_id <= "011010"; --bullet   faire
                end if;
             --explode sprite
             elsif ( instruction(31 downto 26) = "001011") then
                actors(spriteIndex).tile_id <= "011110"; --explosion   faire
      ...
      FOR i IN 0 TO MAX_ACTORS-1 LOOP
        IF (unsigned(global_x) >= unsigned(actors(i).pos_x)) AND 
            ...
            if (actors(i).tile_id = "000000") then
      ...
      -- Si aucun acteur ne correspond, mettre actor_present   '0'
      IF NOT found THEN
         tuile_id <= "000000";
         tuile_x <= "000";
         tuile_y <= "000";
